    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "incremental_max_cards",
                    models.PositiveSmallIntegerField(default=500),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("full", "Full bootstrap"),
                            ("discovery", "Incremental discovery"),
                            ("refresh", "Scheduled refresh"),
                            ("reconciliation", "Full token reconciliation"),
                        ],
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="scrape_targets",
                through="ingestion.TargetListing",
                to="listing.listing",
            ),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["run", "status"], name="ingestion_r_run_id_7913e2_idx"
                    )
                ],
                "constraints": [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="listing_sna_listing_ab549b_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["target", "mode", "created_at"],
                name="ingestion_r_target__83e9e4_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="ingestionrun",
            index=models.Index(
                fields=["status", "created_at"], name="ingestion_r_status_502428_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["target", "last_seen_at"], name="target_list_target__8efcf6_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="targetlisting",
            constraint=models.UniqueConstraint(
                fields=("target", "listing"), name="unique_target_listing"
            ),
        ),
    ]
