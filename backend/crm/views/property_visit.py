...
class PropertyVisitCreateView(APIView):
    ...
    def post(self, request):
        ...
        return Response({"message": "بازدید ثبت شد.", "id": visit.id}, status=201)
...
class PropertyVisitListView(APIView):
    ...
    def get(self, request):
        ...
        visits = PropertyVisitSelector.all(request.user)

        serializer = PropertyVisitListSerializer(visits, many=True)
...
class PropertyVisitUpdateView(APIView):
    ...
    def put(self, request, pk):
        ...
        visit = PropertyVisitSelector.by_id(pk, request.user)
        ...
        return Response(
            {
                ...
                "visit": PropertyVisitDetailSerializer(visit).data,
            },
...
class PropertyVisitDetailView(APIView):
    ...
    def get(self, request, pk):
        ...
        serializer = PropertyVisitDetailSerializer(visit)
