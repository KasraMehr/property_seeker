    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "neighborhoods",
                    models.ManyToManyField(blank=True, to="locations.neighborhood"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="customers", to="crm.tag"
            ),
        ),
        migrations.CreateModel(
            name="CallLog",
            fields=[
                ...
                (
                    "call_type",
                    models.CharField(
                        choices=[("incoming", "ورودی"), ("outgoing", "خروجی")],
                        max_length=20,
                    ),
                ),
                (
                ...
                (
                    "record_file",
                    models.FileField(blank=True, null=True, upload_to="calls/"),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["customer"], name="call_logs_custome_41ca8a_idx"
                    ),
                    models.Index(
                        fields=["handled_by"], name="call_logs_handled_e92bac_idx"
                    ),
                    models.Index(
                        fields=["called_at"], name="call_logs_called__1742a3_idx"
                    ),
                    models.Index(fields=["result"], name="call_logs_result_c0d8f1_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="property_vi_agency__9fdf77_idx",
                    ),
                    models.Index(
                        fields=["visit_date"], name="property_vi_visit_d_afaa22_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["agency", "status"], name="reminders_agency__f8df87_idx"
                    ),
                    models.Index(fields=["due_at"], name="reminders_due_at_624020_idx"),
                ],
            },
        ),
