...
export const SCRAPER_TARGET_DETAIL_FIELDS = [
  {
    ...
    fields: [
      ...
      { key: "zone_detail", label: "زون", type: "nested", nestedKey: "name" },
      { key: "listing_category", label: "دسته‌بندی دیوار" },
      { key: "base_url", label: "URL پایه", type: "link", fullWidth: true },
