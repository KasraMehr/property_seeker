      ...
      fields: [
        {
          ...
          min: 5,
          defaultValue: 60,
          validation: { required: "فاصله اجرا الزامی است", min: "حداقل ۵ دقیقه" },
          span: 6,
        },
        {
          key: "run_mode",
          label: "حالت پیش‌فرض اجرا",
          type: "select",
          required: true,
          placeholder: "انتخاب حالت",
          options: [
            { value: "full", label: "کامل" },
            { value: "incremental", label: "افزایشی" },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          min: 1,
          condition: (values) => values.incremental_enabled === true,
          span: 6,
        },
        {
        ...
        {
          key: "last_watermark_external_id",
          label: "آخرین Watermark ID",
          type: "text",
          required: false,
          placeholder: "شناسه خارجی آخرین آگهی شناخته‌شده",
          span: 6,
        },
      ],
    },
