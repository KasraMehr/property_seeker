  ...
  return (
    <MotionDiv className="space-y-6" delay={0.1}>
      ...
      <Tabs value={activeTab} onChange={setActiveTab} variant="underline">
        <Tabs.List>
          <Tabs.Trigger value="city" icon={Calendar}>شهر</Tabs.Trigger>
          <Tabs.Trigger value="district" icon={TrendingUp}>منطقه</Tabs.Trigger>
          <Tabs.Trigger value="allay" icon={TrendingUp}>محله</Tabs.Trigger>
        </Tabs.List>

        <Tabs.Content value="city">
          <PlaceholderTab title="مدیریت جست و جو در سراسر شهر" icon={Calendar} />
        </Tabs.Content>
