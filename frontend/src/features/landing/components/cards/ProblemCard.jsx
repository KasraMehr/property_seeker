...
export default function ProblemCard({ title, items }) {
  return (
    <motion.div
      ...
      className="bg-glass backdrop-blur-xl border border-border rounded-3xl p-6 shadow-lg"
    >
      {/* Header */}
      ...
      <div className="bg-surface/60 border border-border rounded-2xl overflow-hidden">
        {items.map((item, index) => (
          <motion.div
            ...
            className="p-5 border-b border-border last:border-none transition-colors hover:bg-danger/5"
          >
