// src/features/landing/components/cards/SolutionCard.jsx
...
export default function SolutionCard({ title, items }) {
  return (
    <MotionHover className="h-full">
      <div className="bg-glass backdrop-blur-xl border border-border rounded-3xl p-6 shadow-lg shadow-primary/10 h-full">
        {/* Header */}
        ...
        <MotionStagger className="bg-surface/60 border border-border rounded-2xl overflow-hidden">
          {items.map((item, index) => (
            <MotionItem key={index}>
              <div className="p-5 border-b border-border last:border-none transition-colors hover:bg-primary/5">
