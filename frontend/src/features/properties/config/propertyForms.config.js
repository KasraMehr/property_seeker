    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          required: true,
          dependsOn: "city",
          asyncSource: `${API_ENDPOINTS.LOCATIONS.ZONES.LIST.url}?city={city}&active=true`,
          displayField: "name",
        ...
        },
        {
          ...
          required: true,
          dependsOn: "zone",
          asyncSource: `${API_ENDPOINTS.LOCATIONS.DIVAR_NEIGHBORHOODS.LIST.url}?zone={zone}&active=true`,
          displayField: "name",
          placeholder: "ابتدا زون را انتخاب کنید",
          span: 4,
        },
      ],
    },
