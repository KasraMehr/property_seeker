...
const Select = forwardRef(
  (
    ...
    const sizeMap = {
      sm: {
        wrap: "py-1.5 px-3 text-xs",
        panel: "max-h-48",
        item: "px-3 py-1.5 text-xs",
      },
      md: {
        wrap: "py-2.5 px-4 text-sm",
        panel: "max-h-56",
        item: "px-4 py-2 text-sm",
      },
      lg: {
        wrap: "py-3 px-4 text-base",
        panel: "max-h-64",
    ...
    return (
      ...
      >
        ...
        {/* Error */}
        {isError && (
          <p className="mt-1 text-xs text-danger font-medium animate-fadeIn">
            {error}
          </p>
        )}
